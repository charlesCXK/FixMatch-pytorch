...
def main():
    ...
    no_decay = ['bias', 'bn']
    grouped_parameters = [
        {'params': [p for n, p in model.module.left_model.parameters() if not any(
            nd in n for nd in no_decay)], 'weight_decay': args.wdecay},
        {'params': [p for n, p in model.module.left_model.parameters() if any(
    ...
    grouped_parameters_right = [
        {'params': [p for n, p in model.module.right_model.parameters() if not any(
            nd in n for nd in no_decay)], 'weight_decay': args.wdecay},
        {'params': [p for n, p in model.module.right_model.parameters() if any(
            nd in n for nd in no_decay)], 'weight_decay': 0.0}
    ]
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx in range(args.eval_step):
            ...
            inputs_right = torch.cat((inputs_x, inputs_u_w)).to(args.device)
            ...
            pseudo_label_right = torch.softmax(logits_u_right.detach()/args.T, dim=-1)
